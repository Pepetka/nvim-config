...
M.defaults = {
  ...
  group_rules = {
    ...
    { pattern = "^Toggle:", group = "toggle", icon = "󰔢 " },
    { pattern = "^Folds:", group = "folds", icon = "󰦂 " },
    { pattern = "^Search:", group = "search", icon = "󰺮 " },
    { pattern = "^Text:", group = "text", icon = "󰦨 " },
    { pattern = "^Navigation:", group = "navigation", icon = "󰆹 " },
    { pattern = "^Config:", group = "config", icon = "󰒓 " },
    { pattern = "^Preview:", group = "preview", icon = "󰹆 " },
    { pattern = "^Insert:", group = "insert", icon = "󰏫 " },
    { pattern = "^General:", group = "general", icon = "󰌵 " },
    { pattern = "^External:", group = "external", icon = "󰆌 " },
